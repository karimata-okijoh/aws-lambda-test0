...
*任意の*開始日と終了日に対して、システムはアンケート期間（2026年3月15日～6月27日）を正しく設定できること

**検証対象: 要件 8.1**

### Property 27: 開始前のアクセス制御

*任意の*日付設定に対して、現在日時が2026年3月15日より前の場合、「アンケートはまだ開始されていません」というメッセージが表示され、回答送信が拒否されること
...
*任意の*日付設定に対して、現在日時が2026年3月15日～6月27日の間にある場合、回答送信が正常に受け付けられること
...
| コード | 説明 | HTTPステータス | ユーザーメッセージ |
|--------|------|----------------|-------------------|
| PERIOD_001 | 開始前アクセス | 403 | アンケートはまだ開始されていません（開始日: 2026年3月15日） |
